...
%define centos_efidir http://mirror.centos.org/altarch/7/os/%{_arch}/EFI
%endif
...
if [[ $? == 0 ]]; then
  work/iso-image-create -o ./ironic-deploy.iso -i ./image.initramfs -k ./image.vmlinuz %{?centos_efibootimg:-e ./efiboot.img -E ./EFI}
else
